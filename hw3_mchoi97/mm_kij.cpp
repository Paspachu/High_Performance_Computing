...
template void mm_kij(long double a, const std::vector<long double>& A, const std::vector<long double>& B, long double b, std::vector<long double>& C, int m, int p, int n);